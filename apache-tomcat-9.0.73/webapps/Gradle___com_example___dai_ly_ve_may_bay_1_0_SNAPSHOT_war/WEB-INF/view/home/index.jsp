...
<form action="/customerInfos" method="post" id="book-ticket">
    <fieldset style="align-content: center">
        ...
        <select name="dest" id="dest" onchange="updateLocation()">
            <option name="dest" value="Hà Nội">Sài Gòn</option>
            <option name="dest" value="Sài Gòn">Hà Nội</option>
        ...
        <input style="display: inline-block" type="hidden" id="hiddenPrice" name="price">
...
<script>
    function updatePrice() {
        ...
        document.getElementById("hiddenPrice").value = VND.format(price);
    }
